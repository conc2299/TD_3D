...
set NETLIST "$BENCH_FOLDER/Public/public_case2/input.v"
set SDC "$BENCH_FOLDER/Public/public_case2/input.sdc"
set DEF  "$BENCH_FOLDER/Public/public_case2/input.def"
